...
| Knowledge graph | ✅ | 74 nodes / 266 edges — indicators, hazards (now 3: flash flood, heatwave, **dust storm**), mechanisms, regions, **18 real 2025 events with observed values** (6 auto-detected annual extremes + 12 individually site-verified events, each with its own real verdict), and **6 peer-reviewed citations** grounding 4 of 5 mechanisms in verbatim-verified literature text. Interactive. |
